...
function InPersonEvent() {
  ...
  const [in_personEventsCopy, setin_personEventsCopy] = useState([]);
  ...
  useEffect(() => {
    ...
    if (in_personEvents.length > 0) {
      setin_personEventsCopy(in_personEvents);
    }
  }, []);
  ...
  function handleEnter(e) {
    if (e.keyCode == 13) {
      setin_personEvents(
        in_personEventsCopy.filter((event) => {
