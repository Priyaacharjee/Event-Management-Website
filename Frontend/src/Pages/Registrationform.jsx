        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="w-full lg:w-full">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/*Phone Number*/}
              <div>
                <label htmlFor="PhoneNo" className="block text-sm font-medium text-gray-700 mt-5">
              ...
              {/* Email ID */}
              <div>
                <label htmlFor="Emailid" className="block text-sm font-medium text-gray-700 mt-5">
              ...
              {/* Event Name (Disabled)*/}
              <div>
                <label htmlFor="EventName" className="block text-sm font-medium text-gray-700 mt-5">
                  Event Name
                </label>
                <input
                  type="text"
              ...
              {/* Event Date (Disabled) */}
              <div>
                <label htmlFor="EventDate" className="block text-sm font-medium text-gray-700 mt-5">
                  Event Date
                </label>
                <input
                  type="text"
              ...
              {/* Venue (Disabled) */}
              <div>
                <label htmlFor="Venue" className="block text-sm font-medium text-gray-700 mt-5">
                  Event Venue
                </label>
                <input
                  type="text"
              ...
              <div className="mt-8 text-center">
                <button
                  type="submit"
                  className="w-full bg-indigo-600 text-white p-2 rounded-md hover:bg-indigo-700 transition duration-300 mt-5">
                  Register
                </button>
              </div>
            </form>
