            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative z-0 w-full mb-4 group">
                <input
                  ...
                  className={`block py-2 px-0 w-full text-gray-900 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 ${errors.userName ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-600'
                    } peer`}
                  placeholder=" "
                />
                <label
...
//               <button
//                 type="submit"
//                 className="w-full bg-blue-600 text-white font-bold py-2 rounded shadow hover:bg-blue-700 transition duration-300"
//               >
//                 Sign Up
//               </button>
...
//               <button className="bg-red-500 text-white rounded-full p-2 mr-2">
//                 <FaGoogle />
//               </button>
