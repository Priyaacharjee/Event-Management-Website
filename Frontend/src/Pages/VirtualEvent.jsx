  ...
  return (
    <div className="App">
      ...
      <section className="text-center my-8 p-8">
        ...
        <div className='flex'>
          <p className="text-slate-500 lg:text-xl mt-4 lg:mt-6 text-center lg:text-left font-serif w-[69%]">Join us for our upcoming virtual events, where you can explore a wealth of exciting opportunities from the comfort of your home. Engage with industry leaders and like-minded professionals, participate in interactive discussions, and gain insights into the latest innovations and trends shaping the future. Whether you're looking to expand your network or deepen your knowledge, our virtual meetings offer a dynamic platform to connect and collaborate. Don't miss out on this chance to be part of a thriving online community!</p>
