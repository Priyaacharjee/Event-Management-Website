...
export default function Footer() {
  return (
    <footer className="mt-10 bg-gradient-to-r from-blue-950 to-cyan-900  text-white py-8 px-6">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-300 mt-4">
            ...
            solutions for our clients. Our mission is to deliver excellence
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="https://drive.google.com/file/d/1fIC3CKETxXfNN36SpSeMarLesOpgnx_X/view?usp=drivesdk"
            ...
            <li>
              <a
                href="https://drive.google.com/file/d/1ewvh3hg01vqpOJO4qVVDPPFE7H-kVQaC/view?usp=drivesdk"
                className="text-gray-300 hover:text-blue-400 transition-colors"
              >
                Priya Acharjee
              </a>
            ...
            <li>
              <a
                href="https://drive.google.com/file/d/1eMZtPVV9EoumPvwrryq_q7l5z6DPBBXM/view?usp=drivesdk"
                className="text-gray-300 hover:text-blue-400 transition-colors"
              >
                Shreya Kundu
              </a>
